...
public class NeuralNet {
    private int iNodes, hNodes, oNodes, hLayers; // dimension of  the neural network
    private Matrix[] weights; // weights of the nueral network
    ...
    /**
     * initialize all the weights for this neural network
     */
    ...
    /**
     * mutate all of weights
     *
     * @param mr the percentage/chance of mutation of each weight
     */
    ...
    /**
     * get output for a input arr
     *
     * @param inputsArr inputs for the neural network
     * @return a arr of output arr
     */
    ...
    /**
     * @param partner partner of the neural network
     * @return a child with  combination of both neural networks.
     */
    ...
    /**
     * @return a clone of the neural network
     */
