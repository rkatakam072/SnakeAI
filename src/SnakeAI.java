...
public class SnakeAI extends PApplet {
    ...
    private static Population initial = Population.loadPopulation();
    ...
    public static ArrayList<Integer> evolution;
    ...
    public void setup() {
        ...
        increaseMut = new Button(340, 110, 20, 20, "+");
        decreaseMut = new Button(365, 110, 20, 20, "-");
        frameRate(fps);
        if (humanPlaying) {
            snake = new Snake();
        } else {
    ...
    private static class ShutDownTask implements Runnable {
        ...
        public void run() {
            try {
                ...
                String content = gsonBuilder.create().toJson(initial);

                BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File("C:\\Users\\kittu\\IdeaProjects\\SnakeAI\\Backup.json")));
